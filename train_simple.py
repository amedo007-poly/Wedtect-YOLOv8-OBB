"""
Simple YOLOv8 OBB Training Script for Wedtect
Minimal version to get training started quickly
"""
...
def main():
    ...
    log_msg("🚀 Starting Wedtect YOLOv8 OBB Training")
    log_msg("=" * 70)
    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            log_msg("⚠️  Using CPU (training will be slow)")
            device = "cpu"
    ...
    log_msg("Loading YOLOv8 model...")
    
    model = YOLO('yolov8n-obb.pt')
    log_msg("✅ Model loaded")
    
    log_msg("\n🚀 Beginning training... (this will take 2-5 hours)")
    log_msg("=" * 70)
